...
- **Create Kubernetes Deployemtn file**  
  Make a file named 'deployment.yaml' 
...
- **Clone your GitHub repo**
  ...
  ```bash
  git clone https://github.com/Chetan713205/AI-Powered-Recommendation-System.git
  ls AI-Powered-Recommendation-System
  cd 
...
```bash
git config --global user.email "chetantiwaridgp5@gmail.com"
git config --global user.name "Chetan713205"
...
kubectl port-forward svc/flask-app-service 9000:80 --address 0.0.0.0
